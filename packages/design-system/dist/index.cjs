...
// ../../node_modules/.pnpm/@paysecure-design+tokens@1.0.2_react@18.3.1/node_modules/@paysecure-design/tokens/dist/index.mjs
...
var TokenManager2 = class {
  constructor() {
    ...
    this.worker = wrap(new Worker(new URL("./worker/token.worker.ts", (typeof document === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : (_documentCurrentScript && _documentCurrentScript.tagName.toUpperCase() === 'SCRIPT' && _documentCurrentScript.src || new URL('out.js', document.baseURI).href))).href));
...
var TokenValueSchema = external_exports.object({
  value: external_exports.string(),
  type: external_exports.enum(["color", "spacing", "typography", "shadow", "border", "opacity", "size", "other"]),
  description: external_exports.string().optional(),
  category: external_exports.string()
});
external_exports.object({
  id: external_exports.string(),
  tokens: external_exports.record(TokenValueSchema),
